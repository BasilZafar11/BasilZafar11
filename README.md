...
* 🌍 Based in India and actively looking for full-time opportunities in AI engineering.
* 📫 How to reach me: [https://www.linkedin.com/in/basil-zafar-490b08302/]

### 💡 Featured Projects

* **Custom HTTP Web Server** *Built from scratch in Java.* Designed the core socket implementation, multithreading, and request parsing to handle client-server communication efficiently without relying on high-level frameworks.
* **DormPay**
  *Algorand, Gemini AI.* A campus wallet application built on the Algorand blockchain to help students split bills and manage expenses, featuring an AI financial concierge.
<!--
### 📊 GitHub Stats
